...
writer = SummaryWriter('./log/{}'.format(datetime.datetime.now().__str__().replace(':', '_'))+" DQNbs")
...
def mini_batch_train(env, agent, max_episodes, max_steps, batch_size):
    ...
    for episode in range(max_episodes):
        ...
        for step in range(max_steps):
            ...
            state = next_state
        total_reward += episode_reward - 450
        writer.add_scalar('episode/reward', episode_reward - 450, episode + 1)
